...
public class TaskProfileTest
{
	...
	public static final ValidationSupportRule validationRule = new ValidationSupportRule(def.getResourceVersion(),
			...
			List.of("dsf-task-base-1.0.0.xml", "extension-report-status-error.xml", "task-report-autostart-start.xml",
	...
	private Task createValidTaskSendProcess()
	{
		...
		task.addInput()
				.setValue(new Reference("http://foo.bar/fhir/Binary/" + UUID.randomUUID())
